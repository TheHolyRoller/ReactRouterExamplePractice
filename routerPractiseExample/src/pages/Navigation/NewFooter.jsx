...
function Footer() {
  ...
  <div className={FooterCSS.contentContainer}>
    ...
    <article className={FooterCSS.Logosection}>
   ...
   <div className={FooterCSS.logoContainer}>
    ...
    {/* <svg fill="#1C2033" width="40" height="40" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="M61.7 17.0998C61 14.3998 58.9 12.2998 56.2 11.5998C51.4 10.2998 32 10.2998 32 10.2998C32 10.2998 12.6 10.2998 7.8 11.5998C5.1 12.2998 3 14.3998 2.3 17.0998C1 21.9998 1 31.9998 1 31.9998C1 31.9998 1 42.0998 2.3 46.8998C3 49.5998 5.1 51.6998 7.8 52.3998C12.6 53.6998 32 53.6998 32 53.6998C32 53.6998 51.4 53.6998 56.2 52.3998C58.9 51.6998 61 49.5998 61.7 46.8998C63 42.0998 63 31.9998 63 31.9998C63 31.9998 63 21.9998 61.7 17.0998ZM25.8 41.2998V22.6998L41.9 31.9998L25.8 41.2998Z" /></svg> */}
    ...
    <div className={FooterCSS.headlineContainer}> 
      ...
      <div className={FooterCSS.headline}>
      Subscribe:
      </div>
      </div>
